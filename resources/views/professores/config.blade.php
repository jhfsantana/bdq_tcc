...
@stop
		...
		<ul>
			<li>
				...
				<table class="tg">
				  <tr>
				  	<ul>
				  		<li>Matricula: {{ $professor->matricula }}</li>
	...
	<fieldset>
		...
		<form method="POST" id="professorConfig" action="/professor/config/save">
			...
			<div class="panel panel-warning " >
			    <div class="panel-heading">
			        <div class="panel-title"><strong style="word-spacing: 5px;">Qual disciplina deseja associar a este professor?</strong></div>
			    </div> 
			</div>
			...
			<div class="panel panel-primary " >
			    <div class="panel-heading">
			        <div class="panel-title"><strong style="word-spacing: 5px;">Qual turma deseja associar a este professor?</strong></div>
			    </div> 
			</div>
			<div style="margin-bottom: 15px" class="input-group">
