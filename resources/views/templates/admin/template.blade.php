...
<body>
	...
	<div id="header">
		...
		<div class="headeruser">
			<img src="/images/admin-header.png" style="float: left; margin-left: 47%; margin-top: 41px;">
			<h3 style="float: right; color: #E7E7E7;margin-top: 45px; margin-right: 240px;">Você está logado como administrador(a): {{Auth::guard('web_admins')->user()->name }}</h3>
		</div>
	</div>
