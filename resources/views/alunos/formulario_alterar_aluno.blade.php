	...
	<br>
		...
		<div class="container">    
			        <div class="panel panel-default" >
			            ...
			            <form action="/aluno/dados/alterados" method="post">
							...
							<label>
								...
								<input type="text" id="matricula" name="matricula" class="form-control" placeholder="Matricula" readonly="true" value="{{$aluno->matricula}}">
							
							<label>
								Nome
							</label><i style="color: #FF0000">*</i>
								<input type="text" name="nome" class="form-control" placeholder="Digite o nome" value="{{$aluno->nome}}">

							<label>
								Sobrenome
							</label><i style="color: #FF0000">*</i>
								<input type="text" name="sobrenome" class="form-control" placeholder="Digite o sobrenome" value="{{$aluno->sobrenome}}">
							<label>
								CPF
							</label><i style="color: #FF0000">*</i>
								<input type="text" name="cpf" class="form-control" placeholder="Digite o CPF" value="{{$aluno->cpf}}">
							<label>
								Disciplinas
							</label><i style="color: #FF0000">*</i>
							...
							<label>
								...
								<input type="text" name="email" class="form-control" placeholder="Digite o email" value="{{$aluno->email}}">
